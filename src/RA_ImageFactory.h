...
// TBD: Should we reduce params by using WICRect/RECT?
...
void DrawImageStretched(_In_ HDC hDC, _In_ HBITMAP hBitmap, _In_ const RECT& rcSource, _In_ const RECT& rcDest);
