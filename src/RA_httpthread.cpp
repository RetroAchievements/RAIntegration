...
#pragma warning(push)
#pragma warning(disable : 26490) // unreferenced inline functions
...
BOOL DoBlockingImageUpload(UploadType nType, const std::string& sFilename, std::string& ResponseOut)
{
    ...
    {
        //---------------------------41184676334
        const auto mimeBoundary = "---------------------------41184676334";
        const auto contentType = L"Content-Type: multipart/form-data; boundary=---------------------------41184676334\r\n";
