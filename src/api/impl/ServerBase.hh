...
public:
    // === user functions ===
    GSL_SUPPRESS_F6 Login::Response Login(_UNUSED const Login::Request& /*request*/) noexcept override
    {
    ...
    GSL_SUPPRESS_F6 Ping::Response Ping(_UNUSED const Ping::Request& /*request*/) noexcept override
    {
        return UnsupportedApi<Ping::Response>(Ping::Name());
    }

    GSL_SUPPRESS_F6 ResolveHash::Response ResolveHash(_UNUSED const ResolveHash::Request& /*request*/) noexcept override
    {
