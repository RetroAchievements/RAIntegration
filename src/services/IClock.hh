...
public:
    ...
    /// <summary>Gets the current system time.</summary>
    /// <remarks>
    ///   May change if the user adjusts their clock or the system does (daylight savings).
    /// </remarks>
    virtual std::chrono::system_clock::time_point Now() const = 0;

	/// <summary>Gets a <c>time_point</c> that represents how long the system has been running.</summary>
