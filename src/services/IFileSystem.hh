...
public:
	...
	/// <summary>Gets the base directory of the running executable.</summary>
	virtual const std::wstring& BaseDirectory() const = 0;

	/// <summary>Determines if the specified directory exists.</summary>
	...
	/// <summary>Moves a file from one location to another.</summary>
	...
	/// <returns>
	///   Pointer to a <see cref="TextReader" /> for reading the contents of the file. <c>nullptr</c>
	...
	/// <returns>
	///   Pointer to a <see cref="TextWriter" /> for writing the contents of the file. <c>nullptr</c> if the
	///   file could not be created.
	/// </returns>
	virtual std::unique_ptr<TextWriter> CreateTextFile(const std::wstring& sPath) const = 0;

	/// <summary>Opens the specified file for appending.</summary>
	/// <returns>
	///   Pointer to a <see cref="TextWriter" /> for writing the contents of the file. <c>nullptr</c>
