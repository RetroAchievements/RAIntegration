#ifndef SEARCHIMPL_FLOAT_BE_ALIGNED_H
#define SEARCHIMPL_FLOAT_BE_ALIGNED_H
#pragma once

#include "SearchImpl_float_be.hh"

namespace ra {
namespace services {
namespace search {

class FloatBEAlignedSearchImpl : public FloatBESearchImpl
{
public:
...
protected:
        ...
        std::vector<ra::ByteAddress>& vMatches) const override
    {
        ...
        {
            FloatBESearchImpl::ApplyConstantFilter(pBytes, pBytesStop,
                pPreviousBlock, nComparison, nConstantValue, vMatches);
        }
    }
        ...
        std::vector<ra::ByteAddress>& vMatches) const override
    {
        ...
        {
            FloatBESearchImpl::ApplyCompareFilter(pBytes, pBytesStop,
                pPreviousBlock, nComparison, nAdjustment, vMatches);
        }
    }
...
#endif // SEARCHIMPL_FLOAT_BE_ALIGNED_H
