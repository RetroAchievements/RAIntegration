...
protected:
	explicit ModelPropertyBase(_In_z_ const char* const sTypeName,
							   _In_z_ const char* const sPropertyName) noexcept;
...
public:
	...
	/// <summary>Sets the default value for the property.</summary>
	/// <remarks>
	///   Affects all existing instances where a value has not been set, not just new instances.
	/// </remarks>
