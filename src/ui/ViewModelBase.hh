...
public:
    ...
    GSL_SUPPRESS_F6 void AddNotifyTarget(NotifyTarget& pTarget) noexcept { m_vNotifyTargets.insert(&pTarget); }
    GSL_SUPPRESS_F6 void RemoveNotifyTarget(NotifyTarget& pTarget) noexcept { m_vNotifyTargets.erase(&pTarget); }
