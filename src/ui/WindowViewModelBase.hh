...
public:
	...
	WindowViewModelBase& operator=(WindowViewModelBase&&)
		noexcept(std::is_nothrow_move_assignable_v<ViewModelBase>) = default;


	/// <summary>The <see cref="ModelProperty" /> for the window title.</summary>
	...
	/// <summary>The <see cref="ModelProperty" /> for the dialog result.</summary>
	...
	/// <summary>Shows a window for this view model.</summary>
	void Show();
