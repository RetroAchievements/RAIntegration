...
public:
    ...
    explicit GDIBitmapSurface(int nWidth, int nHeight, ResourceRepository& pResourceRepository) noexcept :
        GDISurface(CreateBitmapHDC(nWidth, nHeight), {0, 0, nWidth, nHeight}, pResourceRepository)
    {}

    GSL_SUPPRESS_TYPE6 // m_hBitmap not initialized, adhered to note below
    explicit GDIBitmapSurface(int nWidth, int nHeight) noexcept :
        GDISurface(CreateBitmapHDC(nWidth, nHeight), {0, 0, nWidth, nHeight})
    {}
...
private:
    HDC CreateBitmapHDC(int nWidth, int nHeight) noexcept
    {
        BITMAPINFO bmi{};
