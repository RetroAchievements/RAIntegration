...
void Dlg_MessageBox::Controller::ShowWindow(ra::ui::WindowViewModelBase& oViewModel)
{
    ShowModal(oViewModel);
}

void Dlg_MessageBox::Controller::ShowModal(ra::ui::WindowViewModelBase& oViewModel)
{
