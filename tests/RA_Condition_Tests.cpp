...
public:
    ...
    TEST_METHOD(TestParseConditionMemoryComparisonValue)
    {
        ...
        AssertParseCondition("0xH1234=8",
            Condition::Standard, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("0xH1234==8",
            Condition::Standard, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("0xH1234!=8",
            Condition::Standard, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, NotEqualTo,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("0xH1234<8",
            Condition::Standard, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, LessThan,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("0xH1234<=8",
            Condition::Standard, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, LessThanOrEqual,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("0xH1234>8",
            Condition::Standard, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, GreaterThan,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("0xH1234>=8",
            Condition::Standard, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, GreaterThanOrEqual,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);

        // delta
        AssertParseCondition("d0xH1234=8",
            Condition::Standard, CompVariable::Type::DeltaMem, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);

        // flags
        AssertParseCondition("R:0xH1234=8",
            Condition::ResetIf, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("P:0xH1234=8",
            Condition::PauseIf, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("A:0xH1234=8",
            Condition::AddSource, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("B:0xH1234=8",
            Condition::SubSource, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
        AssertParseCondition("C:0xH1234=8",
            Condition::AddHits, CompVariable::Type::Address, MemSize::EightBit, 0x1234U, Equals,
            CompVariable::Type::ValueComparison, MemSize::EightBit, 8U, 0);
    ...
    TEST_METHOD(TestParseConditionMemoryComparisonMemory)
    {
        AssertParseCondition("0xL1234!=0xU3456",
            Condition::Standard, CompVariable::Type::Address, MemSize::Nibble_Lower, 0x1234U, NotEqualTo,
