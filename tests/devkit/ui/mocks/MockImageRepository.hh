...
public:
    ...
    void FetchImage(_UNUSED ImageType nType, _UNUSED const std::string& sName, _UNUSED const std::string& sSourceUrl, _UNUSED time_t tLastModified = 0) noexcept override
    {
