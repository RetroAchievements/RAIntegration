...
public:
    TEST_METHOD(TestInitialState)
    {
        ...
        Assert::AreEqual((int)TriggerConditionType::Remember, vmTrigger.ConditionTypes().GetItemAt(8)->GetId());
        Assert::AreEqual(std::wstring(L"Remember"), vmTrigger.ConditionTypes().GetItemAt(8)->GetLabel());
        Assert::AreEqual((int)TriggerConditionType::AddAddress, vmTrigger.ConditionTypes().GetItemAt(9)->GetId());
        Assert::AreEqual(std::wstring(L"Add Address"), vmTrigger.ConditionTypes().GetItemAt(9)->GetLabel());
        Assert::AreEqual((int)TriggerConditionType::AndNext, vmTrigger.ConditionTypes().GetItemAt(10)->GetId());
        Assert::AreEqual(std::wstring(L"And Next"), vmTrigger.ConditionTypes().GetItemAt(10)->GetLabel());
        Assert::AreEqual((int)TriggerConditionType::OrNext, vmTrigger.ConditionTypes().GetItemAt(11)->GetId());
        Assert::AreEqual(std::wstring(L"Or Next"), vmTrigger.ConditionTypes().GetItemAt(11)->GetLabel());
        Assert::AreEqual((int)TriggerConditionType::Measured, vmTrigger.ConditionTypes().GetItemAt(12)->GetId());
        Assert::AreEqual(std::wstring(L"Measured"), vmTrigger.ConditionTypes().GetItemAt(12)->GetLabel());
        Assert::AreEqual((int)TriggerConditionType::MeasuredIf, vmTrigger.ConditionTypes().GetItemAt(13)->GetId());
        Assert::AreEqual(std::wstring(L"Measured If"), vmTrigger.ConditionTypes().GetItemAt(13)->GetLabel());
        Assert::AreEqual((int)TriggerConditionType::Trigger, vmTrigger.ConditionTypes().GetItemAt(14)->GetId());
        Assert::AreEqual(std::wstring(L"Trigger"), vmTrigger.ConditionTypes().GetItemAt(14)->GetLabel());
