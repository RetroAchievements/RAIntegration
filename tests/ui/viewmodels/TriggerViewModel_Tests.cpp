...
public:
    TEST_METHOD(TestInitialState)
    {
        ...
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_0, vmTrigger.OperandSizes().GetItemAt(0)->GetId());
        Assert::AreEqual(std::wstring(L"Bit0"), vmTrigger.OperandSizes().GetItemAt(0)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_1, vmTrigger.OperandSizes().GetItemAt(1)->GetId());
        Assert::AreEqual(std::wstring(L"Bit1"), vmTrigger.OperandSizes().GetItemAt(1)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_2, vmTrigger.OperandSizes().GetItemAt(2)->GetId());
        Assert::AreEqual(std::wstring(L"Bit2"), vmTrigger.OperandSizes().GetItemAt(2)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_3, vmTrigger.OperandSizes().GetItemAt(3)->GetId());
        Assert::AreEqual(std::wstring(L"Bit3"), vmTrigger.OperandSizes().GetItemAt(3)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_4, vmTrigger.OperandSizes().GetItemAt(4)->GetId());
        Assert::AreEqual(std::wstring(L"Bit4"), vmTrigger.OperandSizes().GetItemAt(4)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_5, vmTrigger.OperandSizes().GetItemAt(5)->GetId());
        Assert::AreEqual(std::wstring(L"Bit5"), vmTrigger.OperandSizes().GetItemAt(5)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_6, vmTrigger.OperandSizes().GetItemAt(6)->GetId());
        Assert::AreEqual(std::wstring(L"Bit6"), vmTrigger.OperandSizes().GetItemAt(6)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Bit_7, vmTrigger.OperandSizes().GetItemAt(7)->GetId());
        Assert::AreEqual(std::wstring(L"Bit7"), vmTrigger.OperandSizes().GetItemAt(7)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Nibble_Lower, vmTrigger.OperandSizes().GetItemAt(8)->GetId());
        Assert::AreEqual(std::wstring(L"Lower4"), vmTrigger.OperandSizes().GetItemAt(8)->GetLabel());
        Assert::AreEqual((int)ra::data::Memory::Size::Nibble_Upper, vmTrigger.OperandSizes().GetItemAt(9)->GetId());
